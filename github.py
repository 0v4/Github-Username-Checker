...
while ask < 1:
    ...
    print(Fore.GREEN + "Press 1 to start checking:")
    print(Fore.LIGHTYELLOW_EX + "[1] GitHub")
    ask = int(input(Fore.RESET + "\n> "))
...
if ask == 1:
    ...
    while 1:
        ...
        if req.status_code == 200:
            ...
            with open("Github Results.txt", "a") as results:
                results.write(f"https://github.com/{readl1}" + "\n")
